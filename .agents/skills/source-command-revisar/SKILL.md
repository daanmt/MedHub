...
7. 🔴 **Carimbar `review_log`** para cada tema reabordado (Invariante B) — `dormant_refresh.py --stamp --tema-id <id> --kind directed_review` (ou `dormant_refresh` quando o tema entrou por dormência).  <!-- NAO-VERIFICAVEL: conduta do agente na sessao, sem artefato que a registre -- mesmo vao do Invariante B acima (revisar: 2027-03-31) -->
