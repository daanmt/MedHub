...
### F113 -- cards cunhados SEM acentuacao (ASCII) sao lidos pelo usuario como "erro de portugues"; a convencao de encoding (AGENTE §4.5) foi aplicada ao TEXTO CLINICO do card, nao so a pontuacao -- **MEDIA** -- **PARCIAL (s185: 749 de 874 cards corrigidos; residuo declarado)**
