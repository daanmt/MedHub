...
### F71 -- o balanceador de carga nao conhece o calendario de provas: empurrou cards para o dia SEGUINTE ao ENAMED -- **MEDIA** -- **ABERTO**
...
### F80 -- Writers do `ipub.db` discordam de FUSO: `fsrs_revlog`/`questoes_erros` gravam em UTC, `sessoes_bulk` grava em local -- **MEDIA** -- **ABERTO**
