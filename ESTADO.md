...
*Atualizado: 2026-06-29 (sessão 099) | Ferramenta: Claude Code (Opus 4.8)*
...
- **Contadores:** **54 resumos** em `resumos/` (+Vulvovaginites gold; DHEG reforçado) · **419 erros** em `ipub.db` · **441 cards ativos** (s100: +19 da S11, 652-670) · **taxonomia 98 temas** (`UNIQUE(area,tema)`, áreas 100% canônicas, + colunas `dificuldade*`)
...
- **Volume & Metas:** **4.325 / 10.000 meta-prova (43%)** [teto 12.000]; **+108 na s100** (Semana 11). Perf. geral **79.4%**. Cluster fraco (volume + %): Hepato, Dermato, Otorrino; **0q: Ortopedia, Oftalmo**. **Gargalo nº1 = execução de prova** (bug nº1: não fechar a conduta / exame lido por dado parcial).
- **Conteúdo:** **54 resumos** (+1 na s100: Vulvovaginites gold, DHEG/Síndromes Hipertensivas reforçado). **Gaps:** reescrever `TCE.md` + `Sistemas de Informação em Saúde.md`; ectópica/icterícia neonatal (só andaime). PDFs EMED p/ aula-base mantidos (gitignored).
