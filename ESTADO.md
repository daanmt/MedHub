...
- **Contadores:** **57 resumos** em `resumos/` (+Imunizações, Sepse, Anemias Hemolíticas) · **419 erros** em `ipub.db` · **441 cards ativos** (s100: +19 da S11, 652-670) · **taxonomia 98 temas** (`UNIQUE(area,tema)`, áreas 100% canônicas, + colunas `dificuldade*`)
...
- **Conteúdo:** **57 resumos** (+3 na s101: Imunizações, Sepse, Anemias Hemolíticas). **Gaps:** reescrever `TCE.md` + `Sistemas de Informação em Saúde.md`; ectópica/icterícia neonatal (só andaime). PDFs EMED p/ aula-base mantidos (gitignored).
