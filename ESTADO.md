...
- **FSRS:** dívida 26 atrasados + 17 devidos hoje · pool 684 nunca introduzidos · **teto 60/dia** (s159; regime de dívida sobe até 90 -- **contador do gatilho em disputa, F64**). Invariante C = trava técnica em `record_review` desde a s144. **s162: 45 cards drenados em 3 blocos, 78% de retenção** (contra 64% da s161).
