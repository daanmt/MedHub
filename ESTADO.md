...
*Atualizado: 2026-06-28 ~16:00 (sessão 097) | Ferramenta: Claude Code (Opus 4.8)*
...
- **Contadores:** **52 resumos** em `resumos/` · **364 erros** em `ipub.db` · **386 cards ativos** (curados s097: 29 fundidos + 37 reforjados + 6 novos) · **taxonomia 98 temas** (`UNIQUE(area,tema)`, áreas 100% canônicas, + colunas `dificuldade*`)
