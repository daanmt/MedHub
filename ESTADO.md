...
- **Contadores (derivados: `python tools/day_plan.py --handoff-block`, linha "Erros & Cards" — F53/v. ciclo descolar 2026-09-01):** **128 resumos** · **903 erros** · **1.213 cards ativos** (`needs_qualitative<2`) · **pool FSRS 684** · **taxonomia 244 temas** · **RAG gold-only**.
