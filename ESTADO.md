...
- **Contadores (derivados: `python tools/day_plan.py --handoff-block`, linha "Erros & Cards" — F53/v. ciclo descolar 2026-09-01):** **136 resumos** · **970 erros** · **1.353 cards ativos** (`needs_qualitative<2`) · **pool FSRS 665** · **taxonomia 275 temas** · **RAG gold-only**.
...
- **Volume & Metas:** 6.916 / **10.400 (UERJ @ 01/11)** · ritmo-alvo **~63,3q/dia** (55d) · zona **COBERTURA**. **s169: 95q em 1 dia (87,4%)**, o maior volume diário do ciclo.
