...
- **Contadores:** **53 resumos** em `resumos/` (+MFC) · **384 erros** em `ipub.db` · **406 cards ativos** (curados s097: 29 fundidos + 37 reforjados + 6 novos) · **taxonomia 98 temas** (`UNIQUE(area,tema)`, áreas 100% canônicas, + colunas `dificuldade*`)
