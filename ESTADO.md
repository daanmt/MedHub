...
- **Contadores:** **53 resumos** em `resumos/` (+MFC; Cir. Infantil ampliado) · **400 erros** em `ipub.db` · **422 cards ativos** (s099: +20 da S11 + 16 do simulado) · **taxonomia 98 temas** (`UNIQUE(area,tema)`, áreas 100% canônicas, + colunas `dificuldade*`)
