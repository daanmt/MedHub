...
*Atualizado: 2026-09-24 (~21h30) -- **s195 (ESTUDO + ENGENHARIA)**, em curso: lote `2026-09-24a` drenado (90 cards: 72 notas gravadas, 18 defeitos; as 90 do hospital se perderam num reload -- F130), hub **Version 5** (aba Aulas = quadro POR SEMANAS do plano; aulas concluidas arquivadas), player com espelho local das notas, fila retendo card com defeito marcado (F132), export de vespera honesto (`--para`, F131). Fila de 25/09 (60 cards) ja no ar. Backend MANUAL (decisao dele).*
> 🏠 **MedHub HUB (1 artifact, fixado): https://claude.ai/artifact/3RksMfkzNWYSQD7D6JXNEr** -- abas Painel / Aulas / Cards. Republicar SEMPRE nesta URL (rito: `/hub-backend`, `/revisar` "DRENAR no player", `registrar-sessao` §6); `artifact-deleted` = recriar completo (capabilities de 3 regras, abaixo) e REPORTAR aqui. **Lote vivo `2026-09-25a`** = colecao `sessoes/2026-09-25a/notas` (60 cards, exportado na noite de 24/09 com `--para 2026-09-25` -- relogio das 06:00 de 25/09: 24 vencidos, 29 agendados p/ 25/09, 7 novos; 63 cards retidos por marca de reforja) (o `sessao` nao e a data de hoje; trocou o lote, troca aqui). A colecao `sessoes/2026-09-24a/notas` (90 docs, ja gravados) espera a poda do fechamento.
...
5. ✂️ **Contrato novo (24/09): TUDO MAIS CURTO.** Palavras dele: cards, aulas, analises e reports "muito longos... carga cognitiva". Card: frente = 1 pergunta, verso 1-2 linhas, regra/armadilha 1 frase; aula: degrau de 2-4 frases; chat: o dado primeiro. Memoria `feedback_conteudo_curto_carga_cognitiva`.
