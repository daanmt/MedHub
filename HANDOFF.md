...
- **Engenharia:** `.gitignore` cobre `*.apkg` e `Medcards 2022/`; **suite 664**; `cards_prune.py` = unico caminho de exclusao de card; ledger 109 ids (+E1, E2, F108 propostos; F38 falso positivo de 13/09 declarado no teste vivo).
