...
4. 📚 **Aula-base do sprint JA ENTREGUE** -- `artifacts/aula-s17.html` ("Sprint S17-20", 13 temas, 310 KB, publicado). Nao refazer aula por bloco; usar o artifact como material de abertura de cada tema.
