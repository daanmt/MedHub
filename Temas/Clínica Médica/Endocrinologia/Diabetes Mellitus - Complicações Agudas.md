...
**Evento primordial:** deficiência de insulina (absoluta no DM1; relativa no DM2).
...
- Sintomas neurológicos (letargia, déficit focal, convulsão, coma) na evolução grave
...
- Cetonúria ≥ 2+ **ou** β-hidroxibutirato ≥ 3 mmol/L

---

### 1.7 Alterações Laboratoriais
...
- Revisar medicações em uso; checar aderência à insulina
...
**Bicarbonato:** ⭐ **Contraindicado** em pediatria (risco de edema cerebral)
...
- Critérios diagnósticos (diagnóstico com 1 critério de diagnóstico; 2 maiores; 1 maior + 2 menores; 1 maior + 1 menor se < 5 anos):
  ...
  - **Critérios menores:** cefaleia, vômitos, irritabilidade/letargia, PA elevada
  - **Critérios de diagnóstico:** resposta motora/verbal anormal à dor, postura de decorticação/descerebração, pupila anormal ou paralisia de NC, padrão respiratório anormal
...
- Déficit hídrico maior que na CAD (água total: 9 L no EHH vs. 6 L na CAD)
...
- Ausência de cetose importante: cetonemia normal/levemente ↑ + cetonúria negativa/leve
- Ausência de acidose: **pH arterial > 7,3 e HCO₃ > 18 mEq/L**
...
- Ausência de acidose: pH arterial > 7,3 ou pH venoso > 7,25; HCO₃ > 15 mEq/L
...
- Segue os mesmos 5 pilares da CAD, com **diferenças:**
  ...
  - **Sem bicarbonato** (não há acidose)
...
- ⚠️ Edema cerebral é **raro** no EHH (diferente da CAD)

---

## 3. Hipoglicemia

### 3.1 Fisiopatogenia e Fatores de Risco

**3 linhas de defesa:**
1. ↓ Secreção de insulina (B pancreático)
...
- Adrenérgicos: tremor, palpitações, ansiedade, excitação
- Colinérgicos: sudorese, fome, parestesia
...
2. Glicemia baixa documentada durante os sintomas
3. Regressão dos sintomas após correção

---

### 3.3 Valores de Alerta

- ⭐ **Valor de alerta:** glicemia ≤ 70 mg/dL
- ⭐ **Hipoglicemia clinicamente importante:** < 54 mg/dL
- **Hipoglicemia relativa:** sintomas com glicemia > 70 mg/dL (em diabéticos cronicamente mal controlados)
