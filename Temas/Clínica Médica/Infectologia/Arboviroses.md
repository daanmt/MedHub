...
### 1.1 Fisiopatologia e Fases Clínicas
**Fase Febril (Dias 1 a 7):**
- Início súbito de febre elevada (> 39°C), prostração e dor retro-orbitária.
- **Sintomas clássicos (COMETA):** Cefaleia, Olhos (dor retro-orbitária), Mialgia, Exantema, Trato gastrointestinal (náuseas/vômitos), Artralgia.
- **Exantema:** Maculopapular, difuso, atingindo face, tronco e membros (incluindo palmas e plantas). Geralmente surge entre o 3º e 6º dia.

**Fase Crítica (Após defervescência):**
- ⭐ **Disfunção endotelial:** Mecanismo fisiopatológico central que gera aumento da permeabilidade vascular e **extravasamento plasmático**.
- **Achados do extravasamento:** Hemoconcentração (elevação do hematócrito) e rápida hipoalbuminemia.
- **Clínica e Derrames:** Ascite, derrame pleural, e derrame pericárdico.
- **Choque hipovolêmico:** Principal causa de óbito; ocorre por perda isolada de volume plasmático. Sangramentos não são o evento gerador primordial do choque da doença.

**Fase de Recuperação:**
- Inicia 24 a 48h após a fase crítica, consistindo na reabsorção progressiva do plasma extravasado.

### 1.2 Alterações Laboratoriais e Diagnóstico
**Achados inespecíficos:**
- **Série Branca:** Leucopenia e linfopenia, sendo frequentemente a alteração mais precoce.
- **Série Vermelha e Plaqueta:** Hemoconcentração (casos de gravidade) e intensa plaquetopenia inflamatório-destrutiva.
- **Função Hepática:** Aumento progressivo de aminotransferases (AST/ALT), podendo exceder 1.000 U/L nas formas graves (hepatite actínica da Dengue).

**Diagnóstico Etiológico (Tempo Dependente):**
- **Até o 5º dia de sintomas:** Detecção viral através de pesquisa de **Antígeno NS1** ou RT-PCR.
- **A partir do 6º dia:** Método sorológico ELISA pesquisa de anticorpos **IgM**.

### 1.3 Classificação de Risco Médica (OMS)
**Dengue sem Sinais de Alarme:** Manifestações restritas à fase febril não complicada.

**Dengue com Sinais de Alarme (⚠️ Mnemônico SILVA 3H):**
Sinais precoces precursores da disfunção sistêmica vascular.
- **S**angramento de mucosa
- **I**rritabilidade ou letargia
- **L**íquido acumulado (ascite, derrame cavitário)
- **V**ômitos persistentes
- **A**bdome doloroso (tensão ou dor contínua)
- **H**ipotensão postural ou lipotímia
- **H**epatomegalia
...
### 2.1 Fases Clínicas e Fisiopatologia
**Fase Aguda (0 a 14 dias):**
- Clima tóxico subitâneo com febre intensa aliada à **poliartralgia aguda, simétrica e bilateral**, atingindo primariamente articulações periféricas como tornozelos e distais de mão. Caracterizada muitas vezes com edema inter-articular.
- Diagnóstico em sangue através de RT-PCR (limite até 8º dia) ou Sorologia ELISA (após 6º dia).

**Fase Subaguda (14 a 90 dias):**
- Redução e cessação térmica evoluindo para um cenário subagudo estritamente álgico-articular restritivo.
- Observa-se frequentemente a manifestação mecânica associada à **tenossinovite hipertrófica** podendo simular síndrome do túnel do carpo.

**Fase Crônica (> 90 dias):**
- Perpetuidade inflamatória resultando na degeneração contínua semelhante a condições de padrão artrítico/reumatóide (rigidez matinal mantida e contratura).
- Fatores fisiológicos de predisposição primária à cronificação: pacientes > 45 anos com osteoartropatia mecânica pregressa grave e quadros agudizados altíssimos da Fase Aguda.

### 2.2 Recomendações Terapêuticas
- **Fase Aguda:** Paracetamol, dipirona ou escalonamento analgésico envolvendo opioides puros (tramadol e análogos). **Proscrita qualquer classe AINE (risco cruzado)** e corticosteroides precoces.
- **Fase Subaguda:** Inversão de orientação clínica; torna-se obrigatória a introdução controlada de AINEs específicos ou corticosteroides dose-baixos (prednisona equivalente a 0,5 mg/kg/dia).
- **Fase Crônica:** Protocolo imunomodulador rígido (adição progressiva de sulfassalazina, metotrexato ou hidroxicloroquina) pelo padrão símile-reumatóide.

---

## 3. Zika

### 3.1 Transmissão e Características Base
**Eixos de Contaminação:**
- Contágio originário via vetor, transmissão placentária-intrauterina materno-fetal, bem como **disseminação sexual** (sobrevivência considerável viral detectada intracelularmente em sêmen, exigindo preservante profilático masculino prolongado na relação sexual).
...
- Adultos / Jovens: Efeito neurológico motor simétrico da síndrome reacional desmielinizante de **Guillain-Barré**.
