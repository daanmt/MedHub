...
- **Sífilis Recente (< 1 ano):**
    - **Primária:** Cancro duro (úlcera única, indolor, bordas endurecidas, limpa) + linfadenopatia regional não supurativa. Dura 3 a 8 semanas e some espontaneamente.
...
### Diagnóstico
- **Obrigatório no pré-natal:** Solicitar na 1ª consulta (ideal 1º trimestre), no início do 3º trimestre (28 sem), no parto/aborto, e pós exposição de risco.
- **Exames Diretos (T. pallidum na lesão):** Campo escuro. Pouco factível na prática. São os primeiros a positivar.
...
## 2. Tratamento da Sífilis na Gestação

A **Benzilpenicilina Benzatina (Benzetacil)** intramuscular é a ÚNICA droga com eficácia comprovada que ultrapassa a barreira placentária para prevenção da sífilis congênita.
...
- 🔴 **Esperando Confirmação para Iniciar Remédio:** Questões gostam de apresentar VDRL 1:4 inicial ou o Teste Rápido (que é formato treponêmico) isolado e as opções sugerem "esperar resultado da sorologia definitiva para iniciar". Na gestação: UM Teste = Tratar AGORA.
