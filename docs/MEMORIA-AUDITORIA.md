...
| fato | valor | fonte |
|---|---|---|
| ids no ledger | **95** (F1–F93 + F77b + F79b) | `AUDITORIA_MEDHUB.md` (**F82-F85 na s171**, `§6o`; **F87** s172 `§6p`; **F88-F89 na s174**, `§6q`; **F90 na s175**, `§6r`; **F91-F92 na s175**, `§6s`; **F93 na s176**, `§6t`) |
| status escrito | **49 RESOLVIDO** (+F86 na s171; +F71 F76 F80 F85 F88 na s174; **+F90 F93 na s176**) · **6+1 PARCIAL** (F7, F37-F41 + F57) · **12 ABERTO no cabeçalho** (F35 F36 F42 F72 F77 F77b F78 F79b F81 F87 F89 **F91**) · 7 ABERTO só em ESTADO/HANDOFF (F63-F69) · 2 ANTI-SCOPE · 1 RECONCILIADO · ~~8 SEM STATUS~~ -> **0 SEM STATUS** (Tier 3 triado na s176: F17 F19 superados, F20 F27 F28 resolvidos, F16 F18 F32 parciais com resíduo nomeado) | §3 (remedido **09-09 s174**, HEAD pós-ciclo A; linha de status re-medida **10-09 s176**) |
