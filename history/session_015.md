...
## Decisões tomadas
- Foram transformados fluxogramas descritivos do PDF em um script textual linear (Cenários A, B e C) para o recém nascido visando adequar às regras proibitivas de fluxogramas em ASCII do projeto (`estilo-resumo.md`).
- A seção de tratamento de sífilis congênita foi adaptada à tríade mnemônica NTT ("Notifique, Trie e Trate").

## Próximos passos (se houver)
- Processamento de novos anexos, novos resumos ou revisão de cadernos.
