...
- **Hérnia inguinal indireta:**
    ...
    - ⭐ **Conteúdo por sexo:** no menino, o conteúdo típico é alça intestinal -- por isso sinais obstrutivos (vômitos, distensão, parada de eliminação) acompanham o encarceramento. Na **menina**, o conteúdo frequentemente é o **OVÁRIO** (ocasionalmente a tuba) -- por não ser alça, cursa **SEM sinais obstrutivos** mesmo com massa irredutível e dolorosa; conduta cirúrgica pelo risco de torção, sem a urgência da alça isquêmica. Transiluminação **negativa** confirma conteúdo sólido.
...
- ⚠️ **Padrão de prova -- diferencial com Síndrome de Prune-Belly:** megabexiga + uretero-hidronefrose bilateral também aparecem na **Prune-Belly** ("abdome em ameixa seca"), mas nela a **UCM mostra uretra de calibre normal** (sem válvula obstrutiva) e há a **tríade**: ⭐ **deficiência da musculatura abdominal + criptorquidia bilateral + malformação dilatada do trato urinário** (~95% meninos). Constelação de sinais -> **pensar SÍNDROME**, não VUP isolada; a uretra de calibre normal na UCM exclui a VUP.
...
- ⚠️ **Padrão de prova:** "não cruzar a linha média" é a **regra geral**, mas um Wilms **volumoso pode cruzar** -- a ultrapassagem **não afasta** o diagnóstico quando o conjunto aponta Wilms (**hematúria + bom estado geral + idade ~4-5 anos**). Nenhum sinal isolado fecha massa abdominal infantil.
...
- 🔴 **Menina com hérnia inguinal irredutível SEM sinais obstrutivos = pensar OVÁRIO, não alça.** Ausência de vômito/distensão não afasta encarceramento na menina -- ovário não obstrui como alça faria; transiluminação negativa confirma conteúdo sólido.
...
- 🔴 Hernia inguinal na infancia nao regride espontaneamente: a indicacao e correcao cirurgica eletiva assim que diagnosticada. A janela de observacao ate 1 a 2 anos pertence a hidrocele comunicante, e a tentativa com gonadotrofina corionica pertence a criptorquidia -- transferir qualquer uma delas para a hernia e erro de conduta.
- 🔴 Reducibilidade separa eletivo de urgente, nao operar de nao operar: hernia redutivel e assintomatica vai para cirurgia eletiva; hernia irredutivel com dor, vomitos ou sinais de sofrimento e urgencia.
- ⚠️ Em meninas, o conteudo encarcerado pode ser o ovario, com risco de torcao e perda gonadal mesmo na ausencia de sinais de obstrucao intestinal.
