...
status: active
aliases: [Intoxicações Exógenas, Intoxicação Exógena, Antídotos, Paracetamol, Organofosforado, Salicilato]
---
...
- **Descontaminação Gástrica:**
    - **Lavagem Gástrica:** Útil preferencialmente até **60 minutos** (máximo 2h). Contraindicações: Corrosivos, Hidrocarbonetos (risco pneumonia aspirativa), via aérea desprotegida. ⭐
    - **Carvão Ativado:** Adsorve a maioria das toxinas. Eficaz até 1-2h. ⚠️ **Dose múltipla:** Útil para Cafeína, Fenitoína, Fenobarbital, Carbamazepina, Dapsona.
    - **O que o carvão NÃO aspira:** Lítio, Ferro, Potássio, Álcoois, Cianeto, Ácidos/Álcalis (corrosivos), Metais pesados. 🔴
- **Alcalinização Urinária:** Bicarbonato de sódio (pH > 7,5). Melhora eliminação de: Salicilatos, Fenobarbital, Metotrexato.
- **Hemodiálise:** Indicada em intoxicações graves (Lítio, Metanol, Etileno Glicol, Salicilatos, Fenobarbital).

## 2. Principais Toxíndromes ⭐
---
- **Síndrome Adrenérgica (Simpatomimética):**
    - **Causas:** Cocaína, Crack, Anfetaminas.
...
- **Síndrome Narcótica (Opioide):**
    ...
    - **Tratamento:** **Naloxona**.
- **Síndrome Hipnosedativa:**
    - **Causas:** Benzodiazepínicos, Barbitúricos.
    - **Quadro:** Sonolência, Ataxia, Disartria, Estupor.
    - **Tratamento:** Suporte. **Flumazenil** (apenas para Benzodiazepínicos, com cautela - pode induzir convulsão em usuários crônicos).
...
---
- 🔴 Induzir vômito ou lavagem gástrica em intoxicação por soda cáustica (risco de segunda lesão esofágica).
- 🔴 Prescrever Carvão Ativado para intoxicação por Lítio (não adsorve).
